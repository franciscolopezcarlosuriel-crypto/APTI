...
| **2. Presupuesto** | **1** | La inversión de $60,000.00 MXN es un monto bajo para proyectos tecnológicos institucionales, limitándose a adquisición de hardware básico (computadoras). |
...
2 + 1 + 2 + 1 + 3 + 3 + 4 + 4 + 2 = **22 puntos totales**.
